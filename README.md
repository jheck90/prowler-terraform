...
| [aws_lb_listener.public_secure](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/lb_listener) | resource |
...
| [terraform_remote_state.rs_cloudflare](https://registry.terraform.io/providers/hashicorp/terraform/latest/docs/data-sources/remote_state) | data source |
...
| <a name="input_django_logging_level"></a> [django\_logging\_level](#input\_django\_logging\_level) | Django logging level | `string` | `"DEBUG"` | no |
...
| <a name="input_external_id"></a> [external\_id](#input\_external\_id) | This is the External ID that Prowler will use to assume the role ProwlerScan IAM Role. | `string` | n/a | yes |
...
| <a name="input_iam_principal"></a> [iam\_principal](#input\_iam\_principal) | The IAM principal type and name that will be allowed to assume the role created, leave an * for all the IAM principals in your AWS account. If you are deploying this template to be used in Prowler Cloud please do not edit this. | `string` | `"role/prowler*"` | no |
...
| <a name="input_postgres_admin_user"></a> [postgres\_admin\_user](#input\_postgres\_admin\_user) | PostgreSQL admin username | `string` | `"postgres"` | no |
...
| <a name="input_postgres_user"></a> [postgres\_user](#input\_postgres\_user) | PostgreSQL application username | `string` | `"postgres"` | no |
| <a name="input_prowler_api_version"></a> [prowler\_api\_version](#input\_prowler\_api\_version) | Prowler API version | `string` | `"stable_v1.0.0"` | no |
